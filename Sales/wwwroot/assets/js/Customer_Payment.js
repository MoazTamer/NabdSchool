...
var KTList = function () {
    ...
    var initTable = function () {
        var FromDate = $("#CustomerPayment_DateFrom").val();
        var ToDate = $("#CustomerPayment_DateTo").val();
        // Init datatable --- more info on datatables: https://datatables.net/manual/
        datatable = $(table).DataTable({
            responsive: true,
            processing: true,
            "ajax": {
                "url": "/Customer_Data/GetPayment?FromDate=" + FromDate + "&ToDate=" + ToDate
            },
            "language": {
                "search": "البحث ",
            ...
            "columns": [
                ...
                { "data": "customerPayment_Type" },
                { "data": "cashBalance_Name" },
                { "data": "customerPayment_Money" },
                { "data": "customerPayment_Number" },
                {
                    "data": "customerPayment_Date",
                    render: function (data, type, row) {
                        return moment(data).format('YYYY/MM/DD');
                    }
                },
                {
                    "data": "customerPayment_ID",
                    "render": function (data) {
                        return `
                                <a onclick=EditGet("/Customer_Data/EditPayment/${data}") style="cursor:pointer">
                ...
                },
                {
                    ...
                    "render": function (data) {
                        return `
                                <a onclick=DeletePayment("/Customer_Data/DeletePayment/${data}") style="cursor:pointer">
...
KTUtil.onDOMContentLoaded(function () {
    $("#CustomerPayment_DateFrom").flatpickr();
    $("#CustomerPayment_DateTo").flatpickr();
    KTList.init();
});
...
function EditCustomerPaymentPost() {
