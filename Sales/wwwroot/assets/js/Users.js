...
var KTList = function () {
    ...
    var initTable = function () {
        ...
        datatable = $(table).DataTable({
            ...
            'order': [[2, 'asc']],
            'columnDefs': [
                { targets: [0, 1, 4, 5, 6], orderable: false, searchable: false, className: "text-center" },
            ...
            "columns": [
                ...
                },
                {
                    ...
                    "render": function (data) {
                        return `
                                <a onclick=Delete("/Users/Delete/${data}") style="cursor:pointer">
    ...
    var initToggleToolbar = () => {
        ...
        deleteSelected.addEventListener('click', function () {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    blockUI.block();
                    axios.post('/Users/DeleteRange?lstId=' + arrayId)
