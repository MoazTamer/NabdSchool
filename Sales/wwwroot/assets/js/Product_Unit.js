    ...
    var initTable = function () {
        ...
        datatable = $(table).DataTable({
            ...
            "columns": [
                ...
                { "data": null },
                { "data": "productUnit_Name" },
                {
                    "data": "productUnit_ID",
                    "render": function (data) {
                        return `
                                <a onclick=EditGet("/Product_Unit/Edit/${data}") style="cursor:pointer">
                ...
                },
                {
                    ...
                    "render": function (data) {
                        return `
                                <a onclick=Delete("/Product_Unit/Delete/${data}") style="cursor:pointer">
    ...
    var initToggleToolbar = () => {
        ...
        deleteSelected.addEventListener('click', function () {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    blockUI.block();
                    axios.post('/Product_Unit/DeleteRange?lstId=' + arrayId)
        ...
        form,
        {
            fields: {
                'productUnit_Name': {
                    validators: {
                        notEmpty: {
                            message: 'تأكد من تسجيل إسم الوحدة'
                        }
                    }
                },
            },
