...
var KTList = function () {
    ...
    var initTable = function () {
        var VendorData_ID = $("#VendorData_ID").val();
        ...
        datatable = $(table).DataTable({
            ...
            processing: true,
            "ajax": {
                "url": "/Vendor_Data/GetDetail?VendorID=" + VendorData_ID + "&FromDate=" + FromDate + "&ToDate=" + ToDate
            },
            "language": {
                "search": "البحث ",
                ...
                { "data": "statementType" },
                {
                    ...
                    "render": function (data, type, row) {
                        if (row.statementType == "pay") {
                            return `
                                <a onclick=Detail("/Vendor_Data/DetailPayment/${data}") style="cursor:pointer">
