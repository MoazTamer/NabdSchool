            ...
            form,
            {
                fields: {
                    'customerData_Name': {
                        validators: {
                            notEmpty: {
                                message: 'تأكد من تسجيل إسم العميل'
                            }
                        }
                    },
                    'customerData_BalanceMoney': {
                        validators: {
                            notEmpty: {
                    ...
                    'customerData_MaxMoney': {
                        validators: {
                            notEmpty: {
                                message: 'تأكد من تسجيل قيمة الحد الاقصى للعميل'
                            }
                        }
                    },
                },
                            ...
                            .then(function (response) {
                                if (response.data.isValid) {
                                    swal.fire({
                                        ...
                                        if ($("#CustomerData_ID").val() == 0) {
                                            form.reset();
                                            $("#CustomerData_Date").flatpickr();
                                        }
                                        blockUI.release();
                                    });
                                } else {
