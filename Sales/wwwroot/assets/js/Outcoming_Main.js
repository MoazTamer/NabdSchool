...
var KTList = function () {
    ...
    var initTable = function () {
        ...
        datatable = $(table).DataTable({
            ...
            'order': [],
            'columnDefs': [
                { targets: [0, 1, 3, 4, 5], orderable: false, searchable: false, className: "text-center" },
                { targets: [2], className: "text-center" }
            ],
            "columns": [
                {
                    "data": "outcoming_MainID",
                ...
                { "data": "outcoming_MainName" },
                {
                    ...
                    "render": function (data) {
                        return `
                                <a href="/Outcoming/Sub/${data}" style="cursor:pointer">
                                   <i class="fa-solid fa-diagram-next text-info fs-1"></i>
                                </a>
                           `;
                    }
                },
                {
                    ...
                    "render": function (data) {
                        return `
                                <a onclick=EditGet("/Outcoming/EditMain/${data}") style="cursor:pointer">
                ...
                },
                {
                    ...
                    "render": function (data) {
                        return `
                                <a onclick=Delete("/Outcoming/DeleteMain/${data}") style="cursor:pointer">
    ...
    var initToggleToolbar = () => {
        ...
        deleteSelected.addEventListener('click', function () {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    blockUI.block();
                    axios.post('/Outcoming/DeleteMainRange?lstId=' + arrayId)
        ...
        form,
        {
            fields: {
                'outcoming_MainName': {
                    validators: {
                        notEmpty: {
                            message: 'تأكد من تسجيل إسم البند'
                        }
                    }
                },
            },
