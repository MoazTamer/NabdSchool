...
var KTList = function () {
    ...
    var initTable = function () {
        ...
        datatable = $(table).DataTable({
            ...
            processing: true,
            "ajax": {
                "url": "/Outcoming/GetSub?MainID=" + MainID
            },
            "language": {
                "search": "البحث ",
            ...
            "columns": [
                ...
                { "data": "outcoming_SubName" },
                {
                    ...
                    "render": function (data) {
                        return `
                                <a onclick=EditGet("/Outcoming/EditSub/${data}") style="cursor:pointer">
                ...
                },
                {
                    ...
                    "render": function (data) {
                        return `
                                <a onclick=Delete("/Outcoming/DeleteSub/${data}") style="cursor:pointer">
    ...
    var initToggleToolbar = () => {
        ...
        deleteSelected.addEventListener('click', function () {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    blockUI.block();
                    axios.post('/Outcoming/DeleteSubRange?lstId=' + arrayId)
