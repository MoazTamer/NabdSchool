...
var KTList = function () {
    ...
    var initTable = function () {
        ...
        datatable = $(table).DataTable({
            ...
            'order': [],
            'columnDefs': [
                { targets: [0, 1, 6, 7], orderable: false, searchable: false, className: "text-center" },
            ...
            "columns": [
                ...
                { "data": "employee_Address" },
                {
                    ...
                    "render": function (data) {
                        return `
                                <a href="/Employee/Edit/${data}" style="cursor:pointer">
                ...
                },
                {
                    ...
                    "render": function (data) {
                        return `
                                <a onclick=Delete("/Employee/Delete/${data}") style="cursor:pointer">
    ...
    var initToggleToolbar = () => {
        ...
        deleteSelected.addEventListener('click', function () {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    blockUI.block();
                    axios.post('/Employee/DeleteRange?lstId=' + arrayId)
