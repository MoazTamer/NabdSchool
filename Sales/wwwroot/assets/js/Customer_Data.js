...
var KTList = function () {
    ...
    var initTable = function () {
        ...
        datatable = $(table).DataTable({
            ...
            'order': [],
            'columnDefs': [
                { targets: [0, 1, 6, 7, 8, 9], orderable: false, searchable: false, className: "text-center" },
                { targets: [2, 3, 4, 5], className: "text-center" }
            ],
            "columns": [
                {
                    "data": "customerData_ID",
                ...
                { "data": "customerData_Address" },
                { "data": "customerData_VatNumber" },
                { "data": "customerData_Balance" },
                {
                    "data": "customerData_ID",
                    "render": function (data) {
                        return `
                                <a href="/Customer_Data/Detail/${data}" style="cursor:pointer">
                ...
                },
                {
                    ...
                    "render": function (data) {
                        return `
                                <a href="/Customer_Data/Edit/${data}" style="cursor:pointer">
                ...
                },
                {
                    ...
                    "render": function (data) {
                        return `
                                <a onclick=Delete("/Customer_Data/Delete/${data}") style="cursor:pointer">
    ...
    var initToggleToolbar = () => {
        ...
        deleteSelected.addEventListener('click', function () {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    blockUI.block();
                    axios.post('/Customer_Data/DeleteRange?lstId=' + arrayId)
