...
namespace Sales.Controllers
{
    ...
    //    public StudentController(IUnitOfWork unitOfWork, UserManager<ApplicationUser> userManager, IAuthorizationService authorizationService)
    //    {
    //        _unitOfWork = unitOfWork;
    //        _userManager = userManager;
    ...
    //        {
    //            // Get all classes for filter dropdown
    //            ViewBag.Classes = _unitOfWork.TblClass.GetAll(obj => obj.Class_Visible == "yes")
    ...
    //        try
    //        {
    //            if (!(_authorizationService.AuthorizeAsync(User, "Student_Create").Result).Succeeded)
    //            {
    ...
    //            // Get all classes
    //            var classes = _unitOfWork.TblClass.GetAll(obj => obj.Class_Visible == "yes")
    //                .Select(c => new SelectListItem
    //                {
    //                    Value = c.Class_ID.ToString(),
    //                    Text = c.Class_Name
    ...
    //        try
    //        {
    //            if (!(_authorizationService.AuthorizeAsync(User, "Student_Edit").Result).Succeeded)
    //            {
    ...
    //            {
    //                ViewBag.Type = "error";
    //                ViewBag.Message = "الطالب غير موجود";
    //                return View();
    //            }
    ...
    //            if (student.ClassRoom?.Class_ID != null)
    //            {
    //                ViewBag.ClassRooms = _unitOfWork.TblClassRoom.GetAll(
    //                    obj => obj.Class_ID == student.ClassRoom.Class_ID && obj.ClassRoom_Visible == "yes"
    //                ).Select(cr => new SelectListItem
    //                {
    //                    Value = cr.ClassRoom_ID.ToString(),
    ...
    //        try
    //        {
    //            if (!(_authorizationService.AuthorizeAsync(User, "Student_Delete").Result).Succeeded)
    //            {
    //                return Json(new { isValid = false, title = Title, message = "من فضلك تأكد من وجود صلاحية لفتح هذة النافذة" });
    //            }
    ...
    //            // Soft delete - set visibility to "no" and record who deleted and when
    //            student.Student_Visible = "no";
    //            student.Student_DeleteUserID = _userManager.GetUserId(User);
    //            student.Student_DeleteDate = DateTime.Now;
    ...
    //                        {
    //                            // Read data from Excel
    //                            var studentCode = worksheet.Cells[row, 5].Value?.ToString()?.Trim(); // رقم الطالب
    //                            var studentName = worksheet.Cells[row, 4].Value?.ToString()?.Trim(); // اسم الطالب
    //                            var classNumber = worksheet.Cells[row, 3].Value?.ToString()?.Trim(); // رقم الصف
    //                            var classRoomNumber = worksheet.Cells[row, 2].Value?.ToString()?.Trim(); // الفصل
    //                            var phone = worksheet.Cells[row, 1].Value?.ToString()?.Trim(); // الجوال
    ...
    //                            if (!string.IsNullOrEmpty(classRoomNumber))
    //                            {
    //                                // Try to find classroom by number
    //                                var classRoom = _unitOfWork.TblClassRoom.GetFirstOrDefault(
    //                                    obj => obj.ClassRoom_Name == classRoomNumber && obj.ClassRoom_Visible == "yes"
    //                                );
    ...
    //                                else
    //                                {
    //                                    // Try to find class and create classroom
